        ...
        <div class="content-wrapper">
            <div class="content-header row">
                <div class="content-header-left col-md-6 col-12 mb-2 breadcrumb-new">
                    <h3 class="content-header-title mb-0 d-inline-block">Créer un nouvel article</h3>
                                    ...
                                    <div class="card-body">
                                        <form class="form" action="{{ route('articles.store') }}" method="POST" enctype="multipart/form-data">
                                                            ...
                                                            <div class="card-body">
                                                                ...
                                                                <div class="form-group">
                                                                    <div class="summernote-edit">
                                                                        <textarea id="contenu" class="summernote" name="contenu" rows="10"></textarea>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="date" id="datePublication" class="form-control" name="datePublication" required>
                                            </div>
                                            <div class="form-group">
